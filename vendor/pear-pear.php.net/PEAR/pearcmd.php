...
if ('C:\Users\chizhou\Documents\GitHub\timecapsule\vendor/pear-pear.php.net/PEAR ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\chizhou\Documents\GitHub\timecapsule\vendor/pear-pear.php.net/PEAR '));
    $raw = false;
} else {
